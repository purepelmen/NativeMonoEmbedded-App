...
if(NOT EXISTS ${CORECLR_LIB})
    execute_process(
        COMMAND ${GEN_DEF_TOOL} "${MONO_RUNTIME_DIST}/coreclr.dll"
        COMMAND ${CMAKE_COMMAND} -E rename coreclr.def "${MONO_RUNTIME_LIBS}/coreclr.def"
        COMMAND lib /def:${MONO_RUNTIME_LIBS}/coreclr.def /out:${CORECLR_LIB} /machine:x64
    )
endif()
